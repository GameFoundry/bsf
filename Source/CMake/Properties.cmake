...
if(MSVC)
	...
	set(CMAKE_SHARED_LINKER_FLAGS_RELWITHDEBINFO "/DLL ${BS_LINKER_FLAGS_RELWITHDEBINFO}")
	set(CMAKE_MODULE_LINKER_FLAGS_RELWITHDEBINFO "/DLL ${BS_LINKER_FLAGS_RELWITHDEBINFO}")
	set(CMAKE_EXE_LINKER_FLAGS_RELWITHDEBINFO ${BS_LINKER_FLAGS_RELWITHDEBINFO})

	set(CMAKE_SHARED_LINKER_FLAGS_MINSIZEREL "/DLL ${BS_LINKER_FLAGS_MINSIZEREL}")
	set(CMAKE_MODULE_LINKER_FLAGS_MINSIZEREL "/DLL ${BS_LINKER_FLAGS_MINSIZEREL}")
	set(CMAKE_EXE_LINKER_FLAGS_MINSIZEREL ${BS_LINKER_FLAGS_MINSIZEREL})
	...
	set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "${BS_COMPILER_FLAGS_COMMON} /GL /Gy /Zi /O2 /Oi /MD -DDEBUG")
	set(CMAKE_CXX_FLAGS_MINSIZEREL "${BS_COMPILER_FLAGS_COMMON} /GL /Gy /Zi /O2 /Oi /MD -DNDEBUG")
...
elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang" OR CMAKE_CXX_COMPILER_ID MATCHES "AppleClang")
	...
	set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "${BS_COMPILER_FLAGS_COMMON} -ggdb -O2 -DDEBUG -Wno-unused-variable")
	set(CMAKE_CXX_FLAGS_MINSIZEREL "${BS_COMPILER_FLAGS_COMMON} -ggdb -O2 -DNDEBUG -Wno-unused-variable")
	...
	if(CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
		...
		set(CMAKE_EXE_LINKER_FLAGS_RELWITHDEBINFO "-no-pie")
		set(CMAKE_EXE_LINKER_FLAGS_MINSIZEREL "-no-pie")
...
elseif("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
	...
	set(CMAKE_EXE_LINKER_FLAGS_DEBUG "-no-pie")
	set(CMAKE_EXE_LINKER_FLAGS_RELWITHDEBINFO "-no-pie")
	set(CMAKE_EXE_LINKER_FLAGS_MINSIZEDEL "-no-pie")
	set(CMAKE_EXE_LINKER_FLAGS_RELEASE "-no-pie")
else()

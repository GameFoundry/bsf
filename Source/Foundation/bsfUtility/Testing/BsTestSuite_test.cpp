...
void setupInputConfig()
{
	...
	// allows you to change input buttons without affecting the code that uses
	// it, since the code is only aware of the virtual names.  If you want
	// more direct input, see Input class.
	auto inputConfig = gVirtualInput().getConfiguration();

	// Camera controls for buttons (digital 0-1 input, e.g. keyboard or
	// gamepad button)

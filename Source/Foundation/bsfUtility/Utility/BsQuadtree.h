...
namespace bs
{
	...
	public:
		...
		/** Contains a reference to a specific quadtree node, as well as information about its bounds. */
		class HNode
		{
		public:
			HNode() = default;
		...
		public:
			 ...
			 * bounds.
			 */
			BoxIntersectIterator(const Quadtree& tree, const AABox& bounds)
		 ...
		 */
		Quadtree(const Vector3& center, float extent, void* context = nullptr)
	...
	private:
		...
		PoolAlloc<sizeof(ElementBoundGroup), 512, 8> mElemBoundsAlloc;
	};

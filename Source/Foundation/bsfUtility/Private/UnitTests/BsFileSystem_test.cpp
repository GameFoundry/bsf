...
TEST_F(FileSystemTestSuite, testGetFileSize_zero) {
	...
	createEmptyFile(path);
	ASSERT_EQ(FileSystem::getFileSize(path), 0);
	FileSystem::remove(path);
}
...
TEST_F(FileSystemTestSuite, testGetFileSize_not_zero) {
	...
	ASSERT_EQ(FileSystem::getFileSize(path), 10);
	FileSystem::remove(path);
}
...
TEST_F(FileSystemTestSuite, testMove) {
	...
	ASSERT_TRUE(!FileSystem::exists(source));
	ASSERT_TRUE(FileSystem::exists(destination));
	ASSERT_EQ(readFile(destination), "move-data-source-1");
}
...
TEST_F(FileSystemTestSuite, testMove_overwrite_existing) {
	...
	ASSERT_TRUE(!FileSystem::exists(source));
	ASSERT_TRUE(FileSystem::exists(destination));
	ASSERT_EQ(readFile(destination), "move-data-source-2");
}
...
TEST_F(FileSystemTestSuite, testMove_no_overwrite_existing) {
	...
	ASSERT_TRUE(FileSystem::exists(source));
	ASSERT_TRUE(FileSystem::exists(destination));
	ASSERT_EQ(readFile(destination), "move-data-destination-3");
}
...
TEST_F(FileSystemTestSuite, testCopy) {
	...
	ASSERT_TRUE(FileSystem::exists(source));
	ASSERT_TRUE(FileSystem::exists(destination));
	ASSERT_EQ(readFile(source), "copy-data-source-1");
	ASSERT_EQ(readFile(destination), "copy-data-source-1");
}
...
TEST_F(FileSystemTestSuite, testCopy_overwrite_existing) {
	...
	ASSERT_TRUE(FileSystem::exists(source));
	ASSERT_TRUE(FileSystem::exists(destination));
	ASSERT_EQ(readFile(source), "copy-data-source-2");
	ASSERT_EQ(readFile(destination), "copy-data-source-2");
}
...
TEST_F(FileSystemTestSuite, testCopy_no_overwrite_existing) {
	...
	ASSERT_TRUE(FileSystem::exists(source));
	ASSERT_TRUE(FileSystem::exists(destination));
	ASSERT_EQ(readFile(source), "copy-data-source-3");
	ASSERT_EQ(readFile(destination), "copy-data-destination-3");
}

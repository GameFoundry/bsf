...
TEST(UtilityTestSuite, testBitfield) {
  ...
  ASSERT_TRUE(bitfield.size() == curCount);

  ASSERT_TRUE(bitfield[COUNT + 0] == false);
  ASSERT_TRUE(bitfield[COUNT + 1] == false);
  ASSERT_TRUE(bitfield[COUNT + 2] == true);
  ASSERT_TRUE(bitfield[COUNT + 3] == false);
  ...
  for (UINT32 j = 50; j < 70; j++) ASSERT_TRUE(bitfield[j] == false);

  ASSERT_TRUE(bitfield[5] == false);
  ASSERT_TRUE(bitfield[6] == false);
  ...
  for (UINT32 j = 48; j < 68; j++) ASSERT_TRUE(bitfield[j] == false);
  ...
  // Find
  ASSERT_TRUE(bitfield.find(true) == 0);
  ASSERT_TRUE(bitfield.find(false) == 5);
}
...
TEST(UtilityTestSuite, testSmallVector) {
  ...
  ASSERT_TRUE(v[0].a == 10);
  ASSERT_TRUE(v[3].a == 10);
  ASSERT_TRUE(v[3].b == 0);
  ...
  ASSERT_TRUE(v2[0].a == 10);
  ASSERT_TRUE(v2[3].a == 10);
  ASSERT_TRUE(v2[3].b == 0);
  ASSERT_TRUE(v2[4].a == 3);
  ASSERT_TRUE(v2[4].b == 4);

  // Pop an element
  v2.pop();
  ASSERT_TRUE(v2.size() == 4);
  ASSERT_TRUE(v2[0].a == 10);
  ASSERT_TRUE(v2[3].a == 10);
  ASSERT_TRUE(v2[3].b == 0);
  ...
  ASSERT_TRUE(v3.size() == 4);
  ASSERT_TRUE(v3.capacity() == 4);
  ASSERT_TRUE(v3[0].a == 10);
  ASSERT_TRUE(v3[3].a == 10);
  ASSERT_TRUE(v3[3].b == 0);

  // Remove an element
  v.remove(2);
  ASSERT_TRUE(v.size() == 4);
  ASSERT_TRUE(v[0].a == 10);
  ASSERT_TRUE(v[2].a == 10);
  ASSERT_TRUE(v[3].a == 3);
  ASSERT_TRUE(v[3].b == 4);
  ...
  ASSERT_TRUE(v4.size() == 4);
  ASSERT_TRUE(v4.capacity() == 4);
  ASSERT_TRUE(v4[0].a == 10);
  ASSERT_TRUE(v4[3].a == 10);
  ASSERT_TRUE(v4[3].b == 0);

  // Move a dynamic vector
  SmallVector<SomeElem, 4> v5 = std::move(v2);
  ASSERT_TRUE(v2.size() == 0);
  ASSERT_TRUE(v5.size() == 4);
  ASSERT_TRUE(v5[0].a == 10);
  ASSERT_TRUE(v5[3].a == 10);
  ASSERT_TRUE(v5[3].b == 0);

  // Move a dynamic vector into a dynamic vector
  v.add({33, 44});
  SmallVector<SomeElem, 4> v6 = std::move(v);
  ASSERT_TRUE(v.size() == 0);
  ASSERT_TRUE(v6.size() == 5);
  ASSERT_TRUE(v6[0].a == 10);
  ASSERT_TRUE(v6[3].a == 3);
  ASSERT_TRUE(v6[3].b == 4);
  ASSERT_TRUE(v6[4].a == 33);
  ASSERT_TRUE(v6[4].b == 44);
}
...
TEST(UtilityTestSuite, testDynArray) {
  ...
  ASSERT_TRUE(v[0].a == 10);
  ASSERT_TRUE(v[1].a == 55);
  ASSERT_TRUE(v[2].a == 56);
  ASSERT_TRUE(v[3].a == 57);
  ASSERT_TRUE(v[4].a == 10);
  ASSERT_TRUE(v[5].a == 99);
  ASSERT_TRUE(v[6].a == 10);
  ASSERT_TRUE(v[7].a == 3);
  ASSERT_TRUE(v[7].b == 4);
  ...
  ASSERT_TRUE(v[0].a == 10);
  ASSERT_TRUE(v[1].a == 10);
  ASSERT_TRUE(v[2].a == 10);
  ASSERT_TRUE(v[3].a == 55);
  ASSERT_TRUE(v[4].a == 99);
  ASSERT_TRUE(v[5].a == 10);
  ASSERT_TRUE(v[6].a == 3);
  ASSERT_TRUE(v[6].b == 4);
...
TEST(UtilityTestSuite, testComplex) {
  ...
  ASSERT_TRUE(c.real() == 10.0);
  ASSERT_TRUE(c.imag() == 4.0);

  Complex<float> c2(15.0, 5.0);
  ASSERT_TRUE(c2.real() == 15.0);
  ASSERT_TRUE(c2.imag() == 5.0);

  Complex<float> c3 = c + c2;
  ASSERT_TRUE(c3.real() == 25.0);
  ASSERT_TRUE(c3.imag() == 9.0);

  Complex<float> c4 = c - c2;
  ASSERT_TRUE(c4.real() == -5.0);
  ASSERT_TRUE(c4.imag() == -1.0);

  Complex<float> c5 = c * c2;
  ASSERT_TRUE(c5.real() == 130.0);
  ASSERT_TRUE(c5.imag() == 110.0);

  Complex<float> c6 = c / c2;
  ASSERT_TRUE(c6.real() == 0.680000007f);
  ASSERT_TRUE(c6.imag() == 0.0399999991f);

  ASSERT_TRUE(Complex<float>::abs(c) == 10.7703295f);
  ASSERT_TRUE(Complex<float>::arg(c) == 0.380506366f);
  ASSERT_TRUE(Complex<float>::norm(c) == 116);

  Complex<float> c7 = Complex<float>::conj(c);
  ASSERT_TRUE(c7.real() == 10);
  ASSERT_TRUE(c7.imag() == -4);
  c7 = 0;

  c7 = Complex<float>::polar(2.0, 0.5);
  ASSERT_TRUE(c7.real() == 1.75516510f);
  ASSERT_TRUE(c7.imag() == 0.958851099f);
  c7 = 0;

  c7 = Complex<float>::cos(c);
  ASSERT_TRUE(c7.real() == -22.9135609f);
  ASSERT_TRUE(c7.imag() == 14.8462915f);
  c7 = 0;

  c7 = Complex<float>::cosh(c);
  ASSERT_TRUE(c7.real() == -7198.72949f);
  ASSERT_TRUE(c7.imag() == -8334.84180f);
  c7 = 0;

  c7 = Complex<float>::exp(c);
  ASSERT_TRUE(c7.real() == -14397.4580f);
  ASSERT_TRUE(c7.imag() == -16669.6836f);
  c7 = 0;

  c7 = Complex<float>::log(c);
  ASSERT_TRUE(c7.real() == 2.37679505f);
  ASSERT_TRUE(c7.imag() == 0.380506366f);
  c7 = 0;

  c7 = Complex<float>::pow(c, 2.0);
  ASSERT_TRUE(c7.real() == 84.0000000f);
  ASSERT_TRUE(c7.imag() == 79.9999924f);
  c7 = 0;

  c7 = Complex<float>::sin(c);
  ASSERT_TRUE(c7.real() == -14.8562555f);
  ASSERT_TRUE(c7.imag() == -22.8981915f);
  c7 = 0;

  c7 = Complex<float>::sinh(c);
  ASSERT_TRUE(c7.real() == -7198.72900f);
  ASSERT_TRUE(c7.imag() == -8334.84277f);
  c7 = 0;

  c7 = Complex<float>::sqrt(c);
  ASSERT_TRUE(c7.real() == 3.22260213f);
  ASSERT_TRUE(c7.imag() == 0.620616496f);
  c7 = 0;
}
...
TEST(UtilityTestSuite, testMinHeap) {
  ...
  ASSERT_TRUE(m[0].key.a == 4);
  ASSERT_TRUE(m[0].key.b == 5);
  ASSERT_TRUE(m[0].value == 10);
  ASSERT_TRUE(m.size() == 1);

  int v = 11;
  m.insert(elements, v);
  ASSERT_TRUE(m[1].key.a == 4);
  ASSERT_TRUE(m[1].key.b == 5);
  ASSERT_TRUE(m[1].value == 11);
  ...
  ASSERT_TRUE(minKey.a == 4);
  ASSERT_TRUE(minKey.b == 5);
  ASSERT_TRUE(minValue == 10);

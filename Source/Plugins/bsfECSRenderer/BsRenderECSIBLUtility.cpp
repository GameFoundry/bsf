...
namespace bs { namespace ct
{
	...
	void RenderECSIBLUtility::filterCubemapForSpecular(const SPtr<Texture>& cubemap, const SPtr<Texture>& scratch) const
	{
	...
	{
		return gRenderECS()->getFeatureSet() == RenderECSFeatureSet::Desktop;
	}

	void RenderECSIBLUtility::filterCubemapForIrradiance(const SPtr<Texture>& cubemap, const SPtr<Texture>& output) const
	{
	...
	void RenderECSIBLUtility::filterCubemapForIrradiance(const SPtr<Texture>& cubemap, const SPtr<Texture>& output,
	...
	void RenderECSIBLUtility::scaleCubemap(const SPtr<Texture>& src, UINT32 srcMip, const SPtr<Texture>& dst,
		UINT32 dstMip) const
	{
	...
	void RenderECSIBLUtility::downsampleCubemap(const SPtr<Texture>& src, UINT32 srcMip, const SPtr<Texture>& dst,
		UINT32 dstMip)
	{
		for (UINT32 face = 0; face < 6; face++)
		{
	...
	void RenderECSIBLUtility::filterCubemapForIrradianceNonCompute(const SPtr<Texture>& cubemap, UINT32 outputIdx,
